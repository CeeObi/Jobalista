    ...
    return (
        <div className="mb-5 grid  gap-2 grid-cols-1 sm:grid-cols-3 px-10 sm:px-5 justify-items-center">
            {Object.entries(stats).map(([key, stat]) => {
                ...
                if (stat[0] === "pending") {
                    statsColor = "text-yellow-600";
                    statsBColor = "border-b-yellow-600";
                    statsIconBg = "bg-yellow-100";
                    icon = <FaSuitcaseRolling className="text-3xl text-yellow-600" />;
                }
                if (stat[0] === "interview") {
                    statsColor = "text-blue-600";
                    statsBColor = "border-b-blue-600";
                    statsIconBg = "bg-blue-100";
                    icon = <FaCalendarCheck className="text-3xl text-blue-600" />;
                }
                if (stat[0] === "declined") {
                    statsColor = "text-red-600";
                    statsBColor = "border-b-red-600";
                    statsIconBg = "bg-red-100";
                ...
                return (
                    <StatsItem
                        ...
                        icon={icon}
                        statsIconBg={statsIconBg}
                        statsTitle={stat[0]}
                        count={stat[1]}
                        statsBColor={statsBColor}
                    />
                );
            })}
        </div>
