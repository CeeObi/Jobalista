...
const ChartsContainer = () => {
    ...
    // const datas = [{ name: "test", count: 12 }];
    console.log(data);
    return (
        <>
            <h4 className="text-center font-semibold mt-16">Monthly Applications</h4>
            <h5 className="text-center font-semibold mt-6 text-primary mb-3" onClick={handleDisplayChart}>
                {!barChart ? "See BarChart" : "See AreaChart"}
            </h5>
