...
const AddJob = () => {
    ...
    const {
        ...
        editJobId,
        isTyping,
    } = useSelector((store) => store.jobStore); //user from redux initialState);
                    ...
                    <div className="mt-5 mb-0 grid grid-flow-row-dense gap-4 grid-cols-1 sm:grid-cols-3 grid-rows-3 pb-10 sm:pb-0">
                        ...
                        <div className="mt-5 mb-0 pb-0 flex items-center justify-between">
                            <div className="mx-1 w-1/2 pb-0 mb-0">
                                <FormInput
                                    isDisabled={isTyping ? false : true}
                                    type="reset"
                                    value="Clear"
                                    size=" cursor-not-allowed btn btn-primary"
                                    handleClicked={handleInputReset}
                                />
                            </div>
